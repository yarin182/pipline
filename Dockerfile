...
RUN wget https://s3.eu-west-1.amazonaws.com/ivy2.tar.gz -O /var/lib/jenkins/ivy2.tar.gz 
RUN tar -xvf /var/lib/jenkins/ivy2.tar.gz -C /var/lib/jenkins/ 
RUN mv /var/lib/jenkins/ivy2 /var/lib/jenkins/.ivy2 
