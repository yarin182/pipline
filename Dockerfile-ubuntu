...
RUN \
    ...
    apt-get install -y bash ssh sudo apt-transport-https software-properties-common wget curl vim dos2unix openssl ca-certificates iputils-ping zip unzip gnupg subversion
